            ...
            <div className="max-w-md w-full">
                ...
                <div className="bg-white py-8 px-6 shadow-lg rounded-lg border border-gray-200">
                    ...
                    <a
                        ...
                        className="w-full flex items-center justify-center gap-3 px-6 py-3 border-2 border-gray-300 rounded-lg hover:border-primary hover:bg-primary-50 transition-all duration-200 group"
                    >
